...
in
{
  ...
  BACKPORTS = [
    ...
    (qubesPatch {
      name = "0305-x86-spec-ctrl-Support-for-SRSO_U-S_NO-and-SRSO_MSR_F";
      hash = "sha256-YaRyJWXL8/6yy+ZJBWGK92AK3NFgMivmu+vbJ6sF/Yw=";
    })
    (qubesPatch {
      name = "0306-x86-io-apic-prevent-early-exit-from-i8259-loop-detec";
      hash = "sha256-eSb7uypwBZg/pnpMiSYKA/Fp4DjpezI/pQtL+e6JuUI=";
    })
  ];
  ...
  UPSTREAMABLE_PATCHES = [
    ...
    (qubesPatch {
      name = "0630-tools-xg-increase-LZMA_BLOCK_SIZE-for-uncompressing-";
      hash = "sha256-Llxc2wKSUDeTO73N58YhzKN6Yy8zCxHWNfrxvO9Wods=";
    })
    (qubesPatch {
  ...
  QUBES_SPECIFIC_PATCHES = [
    ...
    (qubesPatch {
      ...
      hash = "sha256-TTo0gg660B48YGBTT9JJYa1HYLLUR1/zaOv6d8Frj7k=";
    })
  ];
  OTHERS = [
    (qubesPatch {
